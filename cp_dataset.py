...
class CPDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.data_path = '/media/erclab/Data02/lai_work/DeepFashion_Try_On/Dataset_bottom/Data320x448/'
    ...
    def __getitem__(self, index):
        ...
        if self.stage == 'GMM':
            ...
            cm = Image.open(osp.join(self.data_path, 'mask', c_name))
        elif self.datamode == 'tran':
            c = Image.open(osp.join(self.data_path,'warp-cloth', c_name))
            cm = Image.open(osp.join(self.data_path, 'warp-mask', c_name))
        else :
            c = Image.open(osp.join('train/test','warp-cloth', c_name))
            cm = Image.open(osp.join(self.data_path, 'warp-mask', c_name))
        c = c.convert("RGB")
        ...
        # person image 
        im = Image.open(osp.join(self.data_path, 'human', im_name))
        im = im.convert("RGB")
        ...
        #load dense pose
        dense = Image.open(osp.join(self.data_path, 'dense', im_name))
